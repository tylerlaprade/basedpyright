        ...
        for (const index in result.match.argParams) {
            ...
            if (
                ((argNode.nodeType === ParseNodeType.Name && p.paramName === argNode.d.value) ||
                    (argNode.nodeType === ParseNodeType.MemberAccess &&
                        argNode.d.leftExpr.nodeType === ParseNodeType.Name &&
                        argNode.d.member.d.value in ['class', 'self'] &&
                        p.paramName === argNode.d.member.d.value)) &&
